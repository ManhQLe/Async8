...
0;this.Link2=[];this.Board=null},_:{MA:function(a){this.Nodes=[];var b=this;a.forEach(function(a,c){for(var e=0;e<a.length;e+=2){var g=b.GetNode(a[e]),f=e+1;if(f<a.length){var k=a[f],f=b.GetNode(a[f+1]);f.InputCount++;g.Link2.push({Local:k,Node:f})}}});this.Leaves=this.Leafed=0;this.LastParams={};this.Nodes.forEach(function(a){a.Link2.length?1:b.Leaves++})}}};Async8.N0.prototype.Fire=function(a,b){this.Async?setImmediate(this.fx,this,a,b,this.Board):this.fx(a,b,this.Board)};
...
Async8._.MA.prototype.ExecNode=function(a,b,d){function c(b,c){var d=Async8._.MA.FX.GetFlows(c),l,h;a.Link2.forEach(function(a){h=a.Node;l=d(h,c);0<l&&(++h.Collected,l--,a.Local?h.Params[a.Local]=b:h.Params=b);e.ExecNode(h,h.Params,l)});a.Link2.length?1:(e.LastParams[a.Name]=b,++e.Leafed==e.Leaves?(e.Leafed=0,e.Endfx?e.Endfx(e.LastParams):0):1)}var e=this;(d?d:0)+a.Collected>=a.InputCount&&(a.Collected=0,a.Fire(c,b))};
Async8._.MA.prototype.Fire=function(a,b,d,c){this.Global=c;this.LastParams={};d?this.Endfx=d:1;var e=this;this.Nodes.forEach(function(c){if(b&&0<=b.indexOf(c.Name)||0==c.InputCount){var d=a.hasOwnProperty(c.Name)?a[c.Name]:{},k;for(k in d)c.Params[k]=d[k];e.ExecNode(c,c.Params,c.InputCount)}})};Async8._.MA.Config={i:0,GetName:function(){return"Annonymous"+this.i++}};
