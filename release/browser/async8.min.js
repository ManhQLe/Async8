...
Async8._.MA.prototype.Fire=function(a,b,d,c){this.Global=c;this.LastParams={};d?this.Endfx=d:1;var e=this;this.Nodes.forEach(function(c){if(b&&0<=b.indexOf(c.Name)||0==c.InputCount){var d=a.hasOwnProperty(c.Name)?a[c.Name]:{};c.Params[x]=d;e.ExecNode(c,c.Params,c.InputCount)}})};Async8._.MA.Config={i:0,GetName:function(){return"Annonymous"+this.i++}};
