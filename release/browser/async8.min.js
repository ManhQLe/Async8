var Async8={Queue:function(a,b,c,e,d){function g(b,d){d?c(d):f<a.length?a[f++](g,b,e):c(b,e)}var f=0;c?1:c=function(){};d?setTimeout(g,0,b):g(b)},PQueue:function(a,b,c,e){c?1:c=function(){};var d=[],g=0,f=!1;a.forEach(function(a,k){d.push(null);setTimeout(a,0,function(a,b){d[k]=a;b&&!f?(f=!0,c(d,b,k,e)):++g==d.length?c(d,e):1},b,k,e)})},DPQueue:function(a,b,c,e,d){d=d?d:a.length;for(var g=[],f=0;f<d;f++)g.push(b);this.PQueue(g,a,c,e)},MA:function(a){return new Async8._.MA(a)},N0:function(a,b,c,e){this.Name=
