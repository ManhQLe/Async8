...
Async8._.MA.prototype.ExecNode=function(a,b,d){function c(b,c){var d=Async8._.MA.FX.GetFlows(c),l,h;a.Link2.forEach(function(a){h=a.Node;l=d(h,c);0<l&&(++h.Collected,l--,h.Params[a.Local]=b);e.ExecNode(h,h.Params,l)});a.Link2.length?1:(e.LastParams[a.Name]=b,++e.Leafed==e.Leaves?(e.Leafed=0,e.Endfx?e.Endfx(e.LastParams):0):1)}var e=this;(d?d:0)+a.Collected>=a.InputCount&&(a.Collected=0,a.Fire(c,b))};
